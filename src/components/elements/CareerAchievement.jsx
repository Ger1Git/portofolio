...
const CareerAchievement = ({ title, date, description, icon, index }) => {
    return (
        <>
            ...
            <div className='py-[20px] px-[30px] bg-white/50 hover:bg-white/80 hover:scale-105 transition-transform duration-300 rounded-[6px] relative shadow-custom group'>
